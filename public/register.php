...
<body><main class="container login-container"><section class="card login-card"><p class="eyebrow">Glider Equipment Tracker</p><details class="language-switcher"><summary aria-label="<?= htmlspecialchars(__('language.choose'), ENT_QUOTES, 'UTF-8'); ?>" title="<?= htmlspecialchars(__('language.choose'), ENT_QUOTES, 'UTF-8'); ?>"><span aria-hidden="true"><?= htmlspecialchars(\Glider\I18n::locales()[\Glider\I18n::locale()]['flag'], ENT_QUOTES, 'UTF-8'); ?></span></summary><div class="language-options"><?php foreach (\Glider\I18n::locales() as $language => $languageInfo): ?><?php if ($language === \Glider\I18n::locale()) { continue; } ?><form method="post" action="/language.php"><input type="hidden" name="language" value="<?= htmlspecialchars($language, ENT_QUOTES, 'UTF-8'); ?>" /><input type="hidden" name="redirect" value="/register.php" /><button type="submit" class="language-option" aria-label="<?= htmlspecialchars($languageInfo['label'], ENT_QUOTES, 'UTF-8'); ?>" title="<?= htmlspecialchars($languageInfo['label'], ENT_QUOTES, 'UTF-8'); ?>"><span aria-hidden="true"><?= htmlspecialchars($languageInfo['flag'], ENT_QUOTES, 'UTF-8'); ?></span></button></form><?php endforeach; ?></div></details><h1><?= htmlspecialchars(__('register.title'), ENT_QUOTES, 'UTF-8'); ?></h1>
