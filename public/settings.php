    ...
    <form method="post" class="stacked-form"<?= $editMode ? ' data-edit-form' : ''; ?>>
        ...
        <?php if (!$editMode): ?>
            <div class="detail-sections">
                ...
                <section class="detail-section"><h3>Bildersuche</h3><div class="detail-grid"><div class="detail-row"><span class="detail-label">Status</span><span class="detail-value"><?= !empty($settings['image_search']['enabled']) ? 'Aktiviert' : 'Deaktiviert'; ?></span></div><div class="detail-row"><span class="detail-label">Quelle</span><span class="detail-value">Openverse (frei lizenzierte Bilder, kein API-Key nötig)</span></div></div></section>
            </div>
        <?php else: ?>
            <div class="form-sections">
                ...
                <section class="form-section"><h3>Bildersuche (Openverse)</h3><div class="row two-col"><label><input type="checkbox" name="image_search_enabled" value="1" <?= !empty($settings['image_search']['enabled']) ? 'checked' : ''; ?> /> Automatische Artikelbildsuche aktivieren</label></div><p class="form-hint">Sucht anhand von Hersteller und Gerätename automatisch ein Artikelbild über die kostenlose Openverse-API (frei lizenzierte Bilder). Kein API-Key oder Konto erforderlich.</p></section>
            </div>
